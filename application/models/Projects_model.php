            ...
            foreach ($timesheets as $t) {
                ...
                if ($type == 'this_week' || $type == 'last_week') {
                    ...
                    foreach ($tmp_weeks as $week) {
                        $start_time_date = legacy_strftime('%Y-%m-%d', $t['start_time']);
        ...
        foreach ($statuses as $status) {
            ...
            foreach ($projects as $project) {
                ...
                $data['desc']     = ' '; // right white background
                    ...
                    $values['from'] = legacy_strftime('%Y/%m/%d', strtotime($project['start_date']));
                $values['to']       = legacy_strftime('%Y/%m/%d', strtotime($project['deadline']));
                $values['desc']     = '';
