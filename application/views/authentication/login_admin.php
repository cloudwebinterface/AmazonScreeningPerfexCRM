  ...
  <div class="row">
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 authentication-form-wrapper">
    ...
    <div class="mtop40 authentication-form">
      <h1>Welcome back</h1>
      <p class="login-subtitle">Staff access for AmazonScreening</p>
      ...
      <div class="form-group">
        ...
        <input type="email" id="email" name="email" class="form-control" autofocus="1" placeholder="you@company.com">
      </div>
      <div class="form-group">
