    ...
    <tbody>
        <?php foreach($timesheets as $timesheet){ ?>
            <tr>
                ...
                <td data-order="<?php echo legacy_strftime('%Y-%m-%d %H:%M:%S', $timesheet['start_time']); ?>">
                    <?php echo _dt($timesheet['start_time'],true); ?>
                </td>
                <td data-order="<?php if(!is_null($timesheet['end_time'])){echo legacy_strftime('%Y-%m-%d %H:%M:%S', $timesheet['end_time']);} ?>"><?php
