...
class App_mailer extends CI_Email
{
    ...
    public function set_mailer_engine($mailer_engine)
    {
        ...
        if ($mailer_engine == 'phpmailer') {
            if (!is_object($this->phpmailer)) {
                if (!class_exists('PHPMailer\\PHPMailer\\PHPMailer', false) && file_exists(APPPATH . 'vendor/autoload.php')) {
                ...
                if (!class_exists('PHPMailer\\PHPMailer\\PHPMailer', true)) {
                    ...
                    if (!$phpmailer_class_exists) {
                        throw new Exception('PHPMailer could not be loaded.');
                    }
    ...
    public function set_newline($newline = "\n")
    {
        ...
        // PHPMailer 6 manages line endings internally via static::$LE.
