...
define('APP_MINIMUM_REQUIRED_PHP_VERSION', '8.1.0');

if (file_exists(APPPATH . 'config/app-config.php')) {
    if (version_compare(PHP_VERSION, APP_MINIMUM_REQUIRED_PHP_VERSION) === -1) {
        echo '<h1>Minimum required PHP version is <b>8.1.0</b>. Consider upgrading to a newer PHP version.</h4>';
        echo '<h3>You are using ' . PHP_VERSION . ', you should consult with your hosting provider to help you to change your PHP version to 8.1.0 or higher, after you upgrade the PHP version this message will disappear.</h3>';
        exit;
    }
...
| setting this variable to TRUE (bool).  See the user guide for details.
|
*/
...
|
| Options are: TRUE or FALSE (bool)
|
...
$config['csrf_exclude_uris'] = [
    ...
    'api\/.+', 
    'webhook\/.+', 
    'admin/history/get_data', 
    'admin/invoice/get_data', 
    'admin/summary/get_data',
    'admin/report/get_data'
];
...
| in your view files.  Options are TRUE or FALSE (bool)
|
