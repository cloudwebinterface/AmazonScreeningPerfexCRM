...
$route['default_controller'] = 'admin/searches';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
 ...
 */
$route['admin']  = "admin/searches";

/**
 * Searches
 */
$route['admin/search/(:num)'] = "admin/searches/search_detail/$1";
$route['admin/search/(:num)/notes'] = "admin/searches/notes/$1";
$route['admin/case/delete/(:num)/(:num)'] = "admin/searches/delete_case/$1/$2";
$route['admin/case/submit/(:num)'] = "admin/searches/submit_case/$1";
$route['admin/new-requests'] = 'admin/searches/new_requests';
$route['admin/summary'] = 'admin/summary';
$route['admin/reports'] = 'admin/searches/new_requests';
$route['admin/report/import_sent_date/(:num)/(:num)'] = "admin/report/import_sent_date/$1/$2";
$route['admin/search/(:num)/pdf'] = "admin/searches/single_search_export/$1";

/**
 * Codes
 */
$route['admin/code/(:any)'] = "admin/codes/code_detail/$1";
