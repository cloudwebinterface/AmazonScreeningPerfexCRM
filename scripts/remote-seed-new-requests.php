<?php
/**
 * Run on production: php /tmp/remote-seed-new-requests.php
 */
if (!defined('BASEPATH')) {
    define('BASEPATH', true);
}
$config = '/www/wwwroot/portal.amazonscreening.com/application/config/app-config.php';
if (!is_file($config)) {
    fwrite(STDERR, "Missing app-config\n");
    exit(1);
}
require $config;
...
$mysqli->set_charset(defined('APP_DB_CHARSET') ? APP_DB_CHARSET : 'utf8');
